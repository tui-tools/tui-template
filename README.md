...
**6. Re-render the screenshots.** `make screenshots` runs the real binary in
...
**7. Set the repository up.** Description, topics (`tui`, `terminal`,
...
**8. Release.** `git tag v0.1.0 && git push origin v0.1.0`, then `make readme`
